...
import { FaPencilAlt, FaPen, FaPencilRuler, FaPenAlt, FaBook, FaRegSmileBeam } from 'react-icons/fa';
...
const Home = () => {
  ...
  const [profileImage, setProfileImage] = useState(`${github}/images/profile/profile.jpg`);
  const certificates = [
    {
    ...
    <Layout>
      <div className='container mx-auto'>
        ...
        <div id='home' className='grid justify-items-center pt-36 space-y-10'>
          {/* profile */}
          <img
            onMouseEnter={() => setProfileImage(`${github}/images/profile/profile-swim.jpg`)}
            onMouseOut={() => setProfileImage(`${github}/images/profile/profile.jpg`)}
          ...
          <div className='p-4 text-center'>
            <h1 className='text-white text-center text-4xl font-bold'>{t('1')}</h1>
        ...
        <div id='projects' className='py-28'>
          ...
          <div className='mt-20 gap-x-4 gap-y-10 md:gap-y-20 grid lg:grid-cols-2 mx-4'>
            ...
            <div>
              <img className='object-cover rounded' src={`${github}/images/projects/project1.png`} alt='project1' />
            </div>
          </div>
          ...
          <div className='mt-20 gap-x-4 gap-y-10 md:gap-y-20 grid md:grid-cols-2 mx-4'>
            ...
            <div>
              <img className='object-cover h-96 rounded' src={`${github}/images/projects/project2.png`} alt='project2' />
            </div>
          </div>
        </div>
        {/* Certificate */}
        <div id='certificate' className='py-28'>
          ...
          <Carousel className='mt-20 mx-4' autoPlay={true} interval={5000} infiniteLoop={true}>
            {certificates &&
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className='mt-20 flex flex-col items-center px-4 gap-8'>
              <div className='flex flex-col items-center w-full gap-2'>
                <label className='text-white w-full md:w-[600px] block' htmlFor='name'>
                  {t(28)} :
                </label>
                <input
              ...
              <div className='flex flex-col items-center w-full gap-2'>
                <label className='text-white w-full md:w-[600px] block' htmlFor='email'>
                  {t(29)} :
                </label>
                <input
                  className='shadow border rounded w-full md:w-[600px] py-2 px-3 text-black focus:outline-none focus:shadow-outline'
              ...
              <div className='flex flex-col items-center w-full gap-2'>
                <label className='text-white w-full md:w-[600px] block' htmlFor='subject'>
                  {t(30)} :
                </label>
                <input
                  className='shadow border rounded w-full md:w-[600px] py-2 px-3 text-black focus:outline-none focus:shadow-outline'
              ...
              <div className='flex flex-col items-center w-full gap-2'>
                <label className='text-white w-full md:w-[600px] block' htmlFor='message'>
                  {t(31)} :
                </label>
                <textarea
                  className='shadow border rounded w-full md:w-[600px] py-2 px-3 text-black focus:outline-none focus:shadow-outline'
